...
- 保存監控相關的 k8s exposure、systemd service template 與交接文件。
...
| `k8s-expose/` | Netdata、VictoriaMetrics NodePort exposure manifests。 |
...
| `docs/pre6g-autoscale-deployment.md` | 早期部署紀錄，作為背景參考。 |
