...
if [ -n "${TEST_IMAGE:-}" ]; then
  ...
  IMAGE_PATH="${HOME}/AutoScale/experiments/yolo26_workload/test_images/sanity_input.png"
fi
...
VM_AGGREGATOR_PATH="${VM_AGGREGATOR_PATH:-${HOME}/AutoScale/vm_aggregator.py}"
